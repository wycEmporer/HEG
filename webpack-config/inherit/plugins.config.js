...
var configPlugins = [
  ...
  //   src: {
  //       cwd: path.resolve(dirVars.publicDir, './less/ico'),
  //       glob: '*.png'
  //     },
  //     target: {
  //       image: path.resolve(dirVars.publicDir, './less/spritesmith-generated/sprite.png'),
  //       css: path.resolve(dirVars.publicDir, './less/spritesmith-generated/sprite.less')
  //     },
