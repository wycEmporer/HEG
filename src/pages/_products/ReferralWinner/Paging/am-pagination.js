...
(function (root, factory) {
    ...
    var Pager = function (ele, opts) {
        ...
        this.click = function (e) {
            ...
            if ($p.hasClass('am-disabled') || $p.hasClass('disabled')) {
                return;
            }
            if ($p.hasClass('pager-first')) {
                ...
                if ($p.hasClass('am-active') || $p.hasClass('active')) {
                    return;
                }
    ...
    Pager.Global = {
        checkDom: function (obj) {
            return typeof HTMLElement === 'object' ? function (obj) {
        ...
        createUITmp: function (copts, celem) { //cpgidx,ctotals,cboundaryLinks,cfirstText,cpageCount,clastText,cprevText,cnextText,cuiType,cspage,cepage
            ...
            if (copts.cuiType === 'bootstrap') {
                ...
                if (copts.cboundaryLinks === true) {
                    htm.push('<li  class=" pager-first ' + (copts.cpgidx === 0 || copts.ctotals <= 0 ? 'disabled' : '') + '" ><a href="#" class="icon icon-first"></a></li>');
                }

                if (copts.cdirectionLinks === true) {
                    htm.push('<li  class=" pager-prev   ' + (copts.cpgidx === 0 || copts.ctotals <= 0 ? 'disabled' : '') + ' "><a href="#" class="icon icon-prve"></a></li>');
                }
                ...
                if (copts.cdirectionLinks === true) {
                    htm.push(' <li class="pager-next ' + (copts.cpgidx === copts.cpageCount - 1 || copts.ctotals <= 0 ? 'disabled ' : '') + '"><a href="#" class="icon icon-next"></a></li>');
                }
                if (copts.cboundaryLinks === true) {
                    htm.push(' <li class=" pager-last ' + (copts.cpgidx === copts.cpageCount - 1 || copts.ctotals <= 0 ? 'disabled' : '') + '"><a href="#" class="icon icon-last"></a></li>');
                }
            } 
