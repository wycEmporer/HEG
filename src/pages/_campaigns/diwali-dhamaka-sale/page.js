...
import { getBannerInfo, DIWALIDHAMAKASALE } from 'pagesDir/_component/getBannerInfo/index';
...
$(() => {
  ...
  getBannerInfo(DIWALIDHAMAKASALE);
  if(!isLogin){
...
$(() => {
  ...
  function GetRTime() {
    ...
    let timestamp_set0 = datetime_to_unix('2018-10-19 00:00:00');
    let timestamp_set2 = datetime_to_unix('2018-11-06 00:00:00');
    let timestamp_set3 = datetime_to_unix('2018-11-10 23:59:59');
